...
if __name__ == "__main__":
    ...
    pred_str = ["豆乾排骨湯六粉", "揍幹排骨湯六粉", "豆乾排骨湯六份"]
    label_str = ["豆乾排骨湯六份", "豆乾排骨湯六份", "豆乾排骨湯六份"]
    print(speech_evaluator(pred_str, label_str, "zh"))
    pred_str = ["tish is a test", "my name is you", "hello, friends"]
    label_str = ["this is a test", "my name is yoona", "hello friends"]
